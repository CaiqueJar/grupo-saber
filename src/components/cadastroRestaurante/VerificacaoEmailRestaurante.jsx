  ...
  const VerificacaoEmailRestaurante = ({ dadosRestaurante }) => {
    ...
    const enviarCodigoEmail = () => {
      ...
      const templateParams = {
        user_email: dadosRestaurante?.email, // tem que bater com o template do EmailJS
        verification_code: novoCodigo,       // mesmo nome da variável no template
      };
